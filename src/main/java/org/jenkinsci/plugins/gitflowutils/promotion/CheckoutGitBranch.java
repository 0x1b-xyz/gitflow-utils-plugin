...
/**
 * Checks the promoted {@link hudson.plugins.git.GitSCM#GIT_BRANCH} in the workspace.
 *
...
public class CheckoutGitBranch extends Builder {
    ...
    public boolean perform(AbstractBuild<?, ?> _build, Launcher launcher, final BuildListener listener)
        ...
        listener.getLogger().println("[gitflow-utils] Checking out " + gitBranch + " into " + workspace.getRemote());
        ...
        listener.getLogger().println("[gitflow-utils] Complete");
